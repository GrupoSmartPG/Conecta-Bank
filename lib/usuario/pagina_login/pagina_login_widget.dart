                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'fzxvw3mu' /* Faça login para acessar 
sua c... */
                              ,
                            ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('Esqueceu_Senha');
                                },
                                text: FFLocalizations.of(context).getText(
                                  'm2xyjvuf' /* Esqueceu sua senha? */,
                                ),
